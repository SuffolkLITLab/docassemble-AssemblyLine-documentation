...
Use the `tap tab` Step to interact with [ALToolbox tabs](../ALToolbox/altoolbox_overview#display-a-series-of-tabs). ALKiln will tap on the tab and then wait until the tab contents are fully visible.
