...
Next, [follow our guide](/docs/components/ALThemeTemplate/althemetemplate_overview) to edit the YAML files and add a custom CSS theme to fit your own organization's needs.
