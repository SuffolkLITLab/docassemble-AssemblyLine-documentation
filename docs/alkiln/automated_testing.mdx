...
**Any docassemble package can use ALKiln**, though it does have special features created especially for projects using AssemblyLine. Give us feedback and propose ideas by making issues at https://github.com/SuffolkLITLab/ALKiln/issues.  <!-- Moved -->

🚧 Reference material for testing your interview with ALKiln. This is under very active development. <!-- Moved -->
...
You can run ALKiln in a variety of ways, each with their [pros and cons and other details](alkiln_advanced.mdx#multiple-ways-to-run-alkiln). The section below is about setting up different ways of running tests. <!-- Moved -->

### Set up for ALKilnInThePlayground <!-- Moved -->
...
### Set up for GitHub-triggered tests <!-- Moved -->
...
### Set up for isolated GitHub server tests <!-- Moved -->
...
### Generate a Story Table <!-- Removed -->
...
See our [**new and improved** security section](security.mdx)!
...
#### Disabling tests in one repository <!-- Moved -->
...
#### Disabling tests for the whole organization <!-- Moved -->
...
### Use a separate server just for testing <!-- Moved -->
...
### See GitHub's security docs <!-- Moved -->
...
### Set ALKiln's npm version <!-- Moved -->
...
### Things to worry about less <!-- Moved -->
