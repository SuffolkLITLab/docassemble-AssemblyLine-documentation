...
(We recommend you [switch to a 2-column Story Table](https://suffolklitlab.org/docassemble-AssemblyLine-documentation/docs/alkiln/trouble/#deprecated-story-tables). We are [moving](writing_tests.mdx#special-html) this old 3-column Story Table documentation.)
