...
The tests run whenever you commit any code to any branch on GitHub. You can read more details and the pros and cons of <GTOYS/> tests below.
...
The tests run whenever you commit any code to any branch on GitHub. You can read more details and the pros and cons of <KittyLitter/> tests below.
...
<GTOYS/> tests are [triggered when you commit code to GitHub](writing_tests.mdx#github-triggers). They then create and test a Project on your docassemble testing server.
