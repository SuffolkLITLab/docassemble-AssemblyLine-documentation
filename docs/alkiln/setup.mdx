...
If you set up <AutoDIY/> tests, any developer can run tests on any of their Projects when they are logged into your docassemble test server. You only have to do this once. You can read more details and the pros and cons of <AutoDIY/> tests below.
