...
This is an error message from a library ALKiln uses called [cucumber](https://cucumber.io/).
...
## <KittyLitter/> Docker trouble (advanced) {#docker-container}
...
:::caution Switch to the 2-column Story Tables
The 3-column format of the Story Table is deprecated. It is old and you should switch to the new 2-column version when you get a chance.
:::
...
<!--
## GitHub tests are passing, but <AutoDIY/> tests are failing
